...
const rootReducer = (state = initialState, { type, payload }) => {
    switch (type) {
        ...
        case GET_POKEMON_DETAIL://detalle especifico
            return {
                ...state,
                pokemonDetail: payload
            };
        case SHOW_MODAL_POKEMON://detalles
            return {
                ...state,
                showModal: payload
            }
        ...
        case SET_TYPE_POKEMONS: //actualiza filtros de tipo,filtra segun el tipo
            let types = [];
            ...
            if (types.length > 1) {
                types.forEach((type) => {
                    if (!filters.includes(type)) {
                        ...
                        filters.splice(filters.indexOf(type), 1);//elimina  el indice
                    };
                });
            ...
            if (filters[0] === 'all') {
                ...
                updateByType = state.pokemonsByStorage.filter(pokemon =>//filtro los que tienen types en filters
            ...
            return {
                ...
                quantityPages: Math.ceil(updateByType.length / state.quantityPokemons),//cantidad pg filtrados
