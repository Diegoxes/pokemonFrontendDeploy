...
const ModalPokemon = () => {
    const pokemon = useSelector((state) => state.pokemonDetail);//utiliza useselector para obtener el estado pokemon detail 
    const dispatch = useDispatch(); 
    const handleClick = () => { dispatch(setShowModal(false)); }; //se ejecuta cuando hago click para ocultar el modal , setShowModal controla si el modal visible esta bien o mal 

    //cuando busco un pokemon en la search se muestra el nombre foto y tipo y ver mas detalles
    return (
